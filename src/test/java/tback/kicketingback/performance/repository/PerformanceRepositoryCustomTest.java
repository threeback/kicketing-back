...
@SpringBootTest
class PerformanceRepositoryCustomTest {
	...
	void getRankingPerformance() {
		...
		List<SimplePerformancePlaceDTO> rankingPerformances
			= performanceRepositoryCustom.findRankingPerformances(range, GetPerformancesSize.of(size));
	...
	void getRankingPerformanceBySize(int size) {
		Range range = DateUnit.WEEK.getRangeCalculator().apply(LocalDate.now());
		List<SimplePerformancePlaceDTO> rankingPerformances = performanceRepositoryCustom.findRankingPerformances(range,
	...
	void getGenreRankingPerformance() {
		...
		List<SimplePerformancePlaceDTO> genreRankingPerformances = performanceRepositoryCustom.findGenreRankingPerformances(
